...
# 文件后缀
filename_suffix = 'Youbangtuwen'

# 需要更新文件目录
target_path = '/Users/xxxxxxxx/Downloads/PeachFriend/PeachFriend/Sections'
# 需要查询文件目录
project_path = '/Users/xxxxxxxx/Downloads/PeachFriend'
# 工程文件地址
pbxpro_path = '/Users/xxxxxxxx/Downloads/PeachFriend/PeachFriend.xcodeproj/project.pbxproj'
...
def file_rename(file_path):
    ...
    if filename.endswith(filename_suffix) == False:
