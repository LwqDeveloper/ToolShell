...
# 将要解析的项目名称
DESPATH = "/Users/jamelee/work/pj-ios-ipa"

# 可能检查出错的图片，需要特别留意下
ERROR_DESPATH = "/Users/jamelee/work/ToolShell/imageUnrefs/unUseImage/error.log"

# 解析结果存放的路径
WDESPATH = "/Users/jamelee/work/ToolShell/imageUnrefs/unUseImage/image.log"

# 项目中没有用到的图片
IMAGE_WDESPATH = "/Users/jamelee/work/ToolShell/imageUnrefs/unUseImage/images/"
